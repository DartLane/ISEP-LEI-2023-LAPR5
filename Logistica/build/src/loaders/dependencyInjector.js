...
const armazemRequests_1 = __importDefault(require("../persistence/armazemRequests"));
const logger_1 = __importDefault(require("./logger"));
exports.default = ({ mongoConnection, schemas, requests, controllers, repos, services }) => {
    try {
        ...
        let requestsClass = new armazemRequests_1.default(); //require(m.path).ArmazemRequests;
        typedi_1.Container.set(requests[0].name, requestsClass);
        repos.forEach(m => {
